      ...
      <div className={styles.page}>
        ...
        <section id="home" className={styles.section}>
          <div className={styles.container}>
            ...
            <div className={styles.text}>
              <h2>Bem-vindo(a) à Plataforma de Saúde Escolar!</h2>
            </div>
          </div>
        </section>
        ...
        <section id="sobre" className={styles.section}>
          <div className={styles.container}>
            <div className={styles.text}>
              <h2>Sobre</h2>
              <p>A Plataforma de Saúde Escolar foi criada para ajudar você a gerenciar e monitorar o estado de saúde dos alunos e sua progressão.</p>
            </div>
        ...
        <section id="contato" className={styles.section}>
          <div className={styles.container}>
            ...
            <div className={styles.text}>
              ...
              <p>Email: PlataformaSaudeEscolarSuporte@hotmail.com</p>
